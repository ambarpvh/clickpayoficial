    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800 backdrop-blur-sm">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight">ClickPay</h1>
        ...
        <div className="space-y-4">
          <Button
            variant="outline"
            className="w-full bg-white hover:bg-zinc-100 text-black border-none h-12 font-medium transition-all active:scale-[0.98]"
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-zinc-800/50 border-zinc-700 text-white h-12 focus:ring-yellow-400/20 focus:border-yellow-400/50"
                required
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="password text-zinc-400">Senha</Label>
              <div className="relative">
                <Input
                  id="password"
                  ...
                  className="bg-zinc-800/50 border-zinc-700 text-white h-12 pr-10 focus:ring-yellow-400/20 focus:border-yellow-400/50"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              className="w-full bg-yellow-400 hover:bg-yellow-500 text-black h-12 font-bold transition-all active:scale-[0.98]"
              disabled={loading}
            >
              {loading ? (
                <div className="w-5 h-5 border-2 border-black/20 border-t-black rounded-full animate-spin" />
      ...
      <div className="mt-8 text-center">
        <a 
          ...
          className="inline-flex items-center gap-2 text-zinc-500 hover:text-green-400 transition-colors text-sm"
        >
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 relative">
      ...
      <div className="glass-card rounded-2xl p-8 w-full max-w-md animate-slide-up relative z-10">
        ...
        <div className="space-y-3 mb-6">
          ...
          <Button variant="outline" className="w-full" onClick={() => handleSocialLogin("apple")} disabled={socialLoading !== null}>
            ...
            {socialLoading === "apple" ? "Conectando..." : "Entrar com Apple"}
          </Button>
        </div>
