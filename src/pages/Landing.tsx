...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Test login button (Opção 2 - Supabase direto) */}
      <section className="border-t border-border/50 py-10 px-4">
        <div className="container mx-auto max-w-md text-center">
          <p className="text-xs text-muted-foreground mb-3">
            🧪 Teste alternativo de login (Opção 2 — Supabase direto, funciona em domínio externo como Vercel)
          </p>
          <Button
            variant="outline"
            className="w-full"
            onClick={async () => {
              ...
              if (error) {
                console.error("Erro login teste:", error);
          ...
          >
            ...
            Entrar com Google (Teste Vercel)
          </Button>
        </div>
      </section>
