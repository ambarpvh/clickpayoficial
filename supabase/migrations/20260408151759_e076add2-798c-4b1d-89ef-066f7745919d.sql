...
-- Remove existing level 2 referrals
DELETE FROM public.referrals WHERE level > 1;

-- Update handle_new_user to remove level 2 logic
...
-- Update ensure_user_setup to remove level 2 logic
